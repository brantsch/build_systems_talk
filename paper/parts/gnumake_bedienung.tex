...
\subsection{Syntax}
	...
	\subsubsection*{Regeln}
		...
		\subsection{Ein Beispiel-\texttt{Makefile}}
			...
			bereits im GdP1-Praktikum im ersten Semester begegnet ist. Damals
			diente es zur Übersetzung der Testate ab einschließlich
			\texttt{Worm080}. Mit der vorliegenden Beschreibung der Syntax und
			Funktionsweise von \texttt{make} sollte es leicht zu verstehen sein.
