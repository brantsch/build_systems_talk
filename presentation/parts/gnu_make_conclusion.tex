...
\begin{frame}
	...
	\begin{itemize}
		\pause
		\item \sout{Unbequemlichkeit des Debuggings/Fehlen eines Debuggers}
			\only<2->{\footnote{\tiny\url{http://gmd.sourceforge.net/} J. Graham-Cummings interaktiver Makefile-Debugger}}
		\pause
